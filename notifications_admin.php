    ...
    try {
        switch ($in['action'] ?? '') {
            ...
            case 'remind_off':
                ...
                $r = notify_custom($pdo, $ids, $lang === 'ar' ? '🔔 فعّل الإشعارات على هاتفك' : '🔔 Turn on notifications on your phone',
                    $lang === 'ar' ? "لتصلك كل المستجدات أولاً بأول:\n1) افتح النظام من هاتفك\n2) ادخل إلى «إشعاراتي» 🔔\n3) اضغط «تفعيل الإشعارات» ثم وافق\n\nآيفون: يجب أولاً إضافة النظام إلى الشاشة الرئيسية (زر المشاركة ← إضافة إلى الشاشة الرئيسية)."
...
$T += $lang === 'ar' ? [
    ...
    's_bank' => 'التذكير إذا لم يرد البنك بعد', 's_co' => 'تذكير «تسجيل الانصراف» الساعة', 's_fail' => 'تنبيه الإدارة بعد محاولات دخول خاطئة', 'days' => 'يوم', 'times' => 'محاولات',
    'dows' => ['الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'],
    's_run' => 'آخر تشغيل للتذكيرات:', 's_never' => 'لم يعمل بعد', 's_cron' => 'ليعمل تذكير الانصراف ليلاً حتى لو لم يفتح أحد النظام: أضف Cron Job كل ١٥ دقيقة لملف notify_cron.php (مثل الملخص اليومي).',
    'b_open' => '🚚 سيارات في الطريق', 'g_transfer' => '🚚 استلام السيارات المنقولة',
    'x_h' => 'استلام السيارات المنقولة', 'x_note' => 'عند نقل سيارة إلى فرع يضغط المسؤول في الفرع «تم الاستلام». تبدأ المهلة من لحظة تسجيل حضوره في الفرع — وإذا كان في إجازة أو لم يكن أحد في الفرع فلا تبدأ المهلة.',
    'x_lock' => 'إيقاف النظام عمّن لا يؤكد في الوقت المحدد', 'x_hours' => 'المهلة المسموحة بعد البصمة', 'x_warn' => 'تنبيهه (وتنبيه الإدارة) قبل الإيقاف بـ', 'x_auto' => 'فتح النظام تلقائياً فور إنجاز كل المطلوب (عند الإيقاف: لا يفتحه إلا الإدارة)',
    'hrs' => 'ساعة', 'mins' => 'دقيقة', 'x_br' => 'الفروع', 'x_conf' => 'يؤكد الاستلام', 'x_store' => 'مخزن — لا يحتاج إلى تأكيد', 'x_who' => 'من يؤكد؟', 'x_anyone' => 'أي شخص سجّل حضوره في الفرع',
    'x_duties' => 'المهل الجارية الآن', 'x_noDuty' => 'لا يوجد أحد مطالب بتأكيد استلام الآن', 'x_cars' => 'سيارة', 'x_left' => 'متبقٍّ', 'x_over' => 'انتهى الوقت', 'x_plus' => '+ساعة', 'x_plus30' => '+30 د',
    'x_locks' => 'موقوف عنهم النظام', 'x_noLock' => 'لا يوجد أحد موقوف عنه النظام ✅', 'x_unlock' => '🔓 فتح النظام', 'x_since' => 'منذ', 'x_doneAll' => '✅ أنجز كل المطلوب', 'x_unlockQ' => 'فتح النظام لـ %s؟', 'x_admin' => 'لا يُوقف النظام عن الإدارة أبداً',
    't_h' => 'قوالب جاهزة', 't_save' => '⭐ حفظ كقالب', 't_empty' => 'لا توجد قوالب — اكتب رسالة واضغط «حفظ كقالب»', 't_del' => 'حذف القالب؟',
    'ack_t' => 'طلب تأكيد الاطلاع «👍» من كل مستلم', 'when' => 'وقت الإرسال', 'w_now' => 'الآن', 'w_later' => 'في وقت محدد', 'sch_ok' => '🕐 تمت الجدولة — ستُرسل %t إلى %p شخص', 'sch_bad' => 'اختر وقتاً في المستقبل',
    'sch_btn' => '🕐 جدولة الرسالة',
    'r_h' => 'الرسائل المرسلة', 'r_note' => '✔✔ قرأها · 👍 أكّد الاطلاع · ⏳ لم يقرأ بعد', 'r_read' => 'قرأها', 'r_ack' => 'أكّد', 'r_none' => 'لم تُرسل أي رسائل بعد', 'r_show' => 'من قرأها؟',
        ...
        <div class="tx-live">
            <div>
                ...
                <div class="tx-d<?= $sec <= 0 ? ' over' : ((int)$d['warned'] ? ' warn' : '') ?>">
                    <div class="i"><b><?= htmlspecialchars($d['username']) ?></b><small><?= $lang === 'ar' ? push_ar_cars((int)$d['n']) : (int)$d['n'] . ' ' . $T['x_cars'] ?> · 📍 <?= htmlspecialchars(push_branch_label($pdo, (string)$d['to_branch'], $lang)) ?></small></div>
